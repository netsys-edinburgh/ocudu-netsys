...
public:
  ...
  //  and will process all unallocated symbols in the indicated slot. Any external DSP processing must be implemented
  //  by this method.
  ///
  /// \param[in]  grid_reader   Resource grid reader, containing the input symbols to be processed.
  /// \param[in]  slot          Current slot.
  ...
  /// its interface. The associated PRACH buffer context contains all the PRACH parameters used by the physical layer
  /// to perform PRACH detection. This includes the frequency and time domain locations of the PRACH within the UL
  //  grid.
  ///
