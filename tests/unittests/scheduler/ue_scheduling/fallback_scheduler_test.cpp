...
TEST_F(fallback_sched_ue_w_out_pucch_cfg, when_reconf_is_after_reest_both_common_and_ded_pucch_are_scheduled)
{
  ...
  u.handle_dl_mac_ce_indication(dl_mac_ce_indication{u.ue_index, lcid_dl_sch_t::UE_CON_RES_ID});
  ...
  ue_cfg.cfg.cause = sched_ue_config_request::causes::rrc_reconf_after_reest;
  ...
  bench->ue_db.reconfigure_ue(ev.next_config(), ue_cfg.cfg.cause);
